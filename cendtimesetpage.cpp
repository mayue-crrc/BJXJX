...
ROMDATA g_PicRom_EndTimeSet[] =
{
    ...
    {QSTR("设定结束时间"),  D_FONT(13),  QRect(  0,  0,640, 60),       Qt::black,                    Qt::yellow,                 CONTROL_LABEL,        ID_IGNORE                },
    ...
    {QSTR("清除"),          D_COMMON_TITLE_FONT,  QRect(450,  250, 100, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICETS_BUTTON_CLEAR    },

    {QSTR("设定"),          D_COMMON_TITLE_FONT,  QRect( 70,  380, 120, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       ID_PICETS_BUTTON_SET      },
    {QSTR("退出"),          D_COMMON_TITLE_FONT,  QRect(260,  380, 120, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       IDBTN_PICETS_QUIT         },
    {QSTR("删除"),          D_COMMON_TITLE_FONT,  QRect(450,  380, 120, 50),        Qt::black,                   Qt::yellow,                 CONTROL_BUTTON,       IDBTN_PICETS_DEFAULT      },
...
void CEndTimeSetPage::OnDefaultButtonUp()
{
    ...
    if (E_INVOKE_HISTORY == g_invoke_type)
    {
        ...
        ((CHistoryFaultListPage *)pPage)->SetEndTime(QSTR("全部"));
    }
    else if (E_INVOKE_CURRENT == g_invoke_type)
    {
        ChangePage(PAGE_ROM_INDEX_CURRENTFAULTLIST);
        CPage* pPage = g_PageVec[CGlobal::m_nCurPageIndex];
        ((CCurrentFaultListPage *)pPage)->SetEndTime(QSTR("全部"));
    }
}
